 ...
 * the Parser using the THINKGEAR_parseByte() function, and a user              --REMEMBER THIS!!!
...
typedef struct _ThinkGearStreamParser {
    ...
    void (*handleDataValue)( unsigned char extendedCodeLevel, unsigned char code, unsigned char numBytes, const unsigned char *value, void *customData, struct Queue* queue, struct Queue* queue1);
    void  *customData;

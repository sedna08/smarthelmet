...
set grid x,y;
show grid;
plot "downdata.bin" binary format="%double%double%double%double%double%double%double%double%double%double%double%double" using 1:12 title 'PERCLOS' with lines lw 1, \
